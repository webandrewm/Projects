...
import styles from '../components/OneCardPersonel.module.css'
    ...
    <>
      <div className={styles.desktopSX}>
        ...
        <div className={styles.textbox2}>
          <span>
            Price for one: {item.price ? item.price.toFixed(2) : ''} rub
          </span>
        </div>
        <button
          onClick={() => {
        ...
        <div className={styles.textbox3}>
          <span className={styles.text09}>{item.counts}</span>
        </div>
        <button
          onClick={() => {
